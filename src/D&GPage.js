...
function DGPage(props) {
    ...
    const DGs = {
        ...
        params: { limit: '100', brand: 'dolce&gabana' },
        headers: {
        ...
        <Jumbotron fluid>
            <Container>
                <Row>
                    ...
                    <Col xs={6} md={4}>
                        <Image src="https://1000logos.net/wp-content/uploads/2017/05/Prada-Logo.png" roundedCircle thumbnail />
                    </Col>
                    {/* <Col xs={6} md={4}>
