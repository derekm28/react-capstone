...
function GivenchyPage(props) {
    ...
    const givenchys = {
        ...
        params: { limit: '100', brand: 'givenchy' },
        headers: {
    ...
    useEffect(() => {
        async function getSneakers() {
          axios.request(givenchys).then(res => {
            setSneakers(res.data.results)
        ...
        <Jumbotron fluid>
            <Container>
                <Row>
                    ...
                    <Col xs={6} md={4}>
                        <Image src="https://1000logos.net/wp-content/uploads/2019/11/Givenchy-Logo.png" roundedCircle thumbnail />
                    </Col>
                    {/* <Col xs={6} md={4}>
