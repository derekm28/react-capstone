...
class User {
  /** authenticate/log in user with username, password.
   *
   ...
   *
   * Returns { username, first_name, last_name, saved_sneakers }
   *   where sneakers is { sneaker_id, title, brand, colorway, name, shoe, image_url }
   *
  ...
  static async saveAShoe(username, sneakerId) {
    ...
    await db.query(
          `INSERT INTO saved_sneakers (sneaker_id, username)
           VALUES ($1, $2)`,
        [sneakerId, username]);
  }
}
